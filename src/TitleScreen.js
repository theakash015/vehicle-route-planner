...
//           The route optimisation solution
//         </Typography>
//       </Header>
//       <Form>
...
function TitleScreen({ onNext }) {
  const handleRouteCalculated = (routeObject) => {
    onNext(routeObject);
  };

  return (
    <div>
      <AddressScreen onRouteCalculated={handleRouteCalculated} />
    </div>
  );
}
